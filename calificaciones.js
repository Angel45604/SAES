			...
			if(grupo.localeCompare("3IM3")==0)
			{
				...
				<table cellspacing=\"0\" cellpadding=\"4\" align=\"Center\"rules=\"cols\"border=\"1\"id=\"ctl00_mainCopy_GV_Calif\"style=\"color:Black;background-color:White;border-color:#DEDFDE;border-width:1px;border-style:Solid;border-collapse:collapse;\">\
					...
					<tr style=\"color:#333333;background-color:#F2F2F2;font-family:Arial;font-size:X-Small;\">\
						...
						<td>-</td>\
						<td id=\"calif_poo2\"><input id=\"fisicabtn\" type=\"button\" value=\"RELLENAR\" onClick=\"rellenar_poo()\"/>\
						</td>\
					</tr>\
					<tr style=\"color:#333333;background-color:White;font-family:Arial;font-size:X-Small;\">\
						<td id=\"calif_grupo9\">3IM8</td>\
						<td>LAB. DE PROYECTOS DE TECNOLOGIAS DE LA INFORMACION I</td>\
						<td>-</td>\
						<td>-</td>\
						<td id=\"calif_lab\">\
						<select id=\"lab\">\
						...
						<td>-</td>\
						<td id=\"calif_lab2\"><input id=\"fisicabtn\" type=\"button\" value=\"RELLENAR\" onClick=\"rellenar_lab()\"/>\
						</td>\
					</tr>\
					<tr style=\"color:#333333;background-color:White;font-family:Arial;font-size:X-Small;\">\
						<td id=\"calif_grupo9\">3IM8</td>\
						<td>ADMON. DE PROYECTOS DE TECNOLOGIAS DE LA INFORMACION I</td>\
						<td>-</td>\
						<td>-</td>\
						<td id=\"calif_admon\">\
						<select id=\"admon\">\
						...
						<td>-</td>\
						<td id=\"calif_admon2\"><input id=\"fisicabtn\" type=\"button\" value=\"RELLENAR\" onClick=\"rellenar_admon()\"/>\
						</td>\
					</tr>\
				</table>";
				}
...
function rellenar_poo(){
	var poo = document.getElementById('poo').value;
	document.getElementById('poo').style.display="none";
	document.getElementById('calif_poo').innerHTML=poo;
	document.getElementById('calif_poo2').innerHTML=poo;
}

function rellenar_lab(){
	var lab = document.getElementById('lab').value;
	document.getElementById('lab').style.display="none";
	document.getElementById('calif_lab').innerHTML=lab;
	document.getElementById('calif_lab2').innerHTML=lab;
}

function rellenar_admon(){
	var admon = document.getElementById('admon').value;
	document.getElementById('admon').style.display="none";
	document.getElementById('calif_admon').innerHTML=admon;
	document.getElementById('calif_admon2').innerHTML=admon;
}